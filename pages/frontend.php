...
$n1['field'] = '<i>'.$this->i18n("ipErk").'</i><input class="form-control test" type="text" id="rex-maintenance-ip" name="config[ip]" value="' . $addon->getConfig('ip') . '"/><i>'.$this->i18n("ipAkt").$_SERVER['REMOTE_ADDR'].'</i>';
$formElements[] = $n1;
$n = [];
