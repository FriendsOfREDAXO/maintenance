...
$field = $form->addTextField('maintenance_backend_text_en');
$field->setLabel($addon->i18n('maintenance_backend_text_en_label'));
$field->setNotice($addon->i18n('maintenance_backend_text_en_notice'));

// Text für den Wartungsmodus (Deutsch)
$field = $form->addTextField('maintenance_backend_text_de');
$field->setLabel($addon->i18n('maintenance_backend_text_de_label'));
$field->setNotice($addon->i18n('maintenance_backend_text_de_notice'));
